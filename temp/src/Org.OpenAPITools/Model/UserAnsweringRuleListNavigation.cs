...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserAnsweringRuleListNavigation :  IEquatable<UserAnsweringRuleListNavigation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserAnsweringRuleListNavigation" /> class.
        /// </summary>
        /// <param name="firstPage">firstPage.</param>
        /// <param name="nextPage">nextPage.</param>
        /// <param name="previousPage">previousPage.</param>
        /// <param name="lastPage">lastPage.</param>
        public UserAnsweringRuleListNavigation(UserAnsweringRuleListNavigationPage firstPage = default(UserAnsweringRuleListNavigationPage), UserAnsweringRuleListNavigationPage nextPage = default(UserAnsweringRuleListNavigationPage), UserAnsweringRuleListNavigationPage previousPage = default(UserAnsweringRuleListNavigationPage), UserAnsweringRuleListNavigationPage lastPage = default(UserAnsweringRuleListNavigationPage))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserAnsweringRuleListNavigation {\n");
        ...
        {
            return this.Equals(input as UserAnsweringRuleListNavigation);
        }

        /// <summary>
        /// Returns true if UserAnsweringRuleListNavigation instances are equal
        /// </summary>
        /// <param name="input">Instance of UserAnsweringRuleListNavigation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserAnsweringRuleListNavigation input)
        {
            if (input == null)
                return false;
