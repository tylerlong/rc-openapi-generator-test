...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WirelessPointInfo :  IEquatable<WirelessPointInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WirelessPointInfo" /> class.
        /// </summary>
        /// <param name="uri">Link to the wireless point resource.</param>
        ...
        public WirelessPointInfo(string uri = default(string), string id = default(string), string bssid = default(string), string name = default(string), AutomaticLocationUpdatesSiteInfo site = default(AutomaticLocationUpdatesSiteInfo), LocationUpdatesEmergencyAddressInfo emergencyAddress = default(LocationUpdatesEmergencyAddressInfo), ERLLocationInfo emergencyLocation = default(ERLLocationInfo), string emergencyLocationId = default(string))
        {
            this.Uri = uri;
            this.Id = id;
            this.Bssid = bssid;
        ...
        /// </summary>
        /// <value>Link to the wireless point resource</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WirelessPointInfo {\n");
        ...
        {
            return this.Equals(input as WirelessPointInfo);
        }

        /// <summary>
        /// Returns true if WirelessPointInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of WirelessPointInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WirelessPointInfo input)
        {
            if (input == null)
                return false;
