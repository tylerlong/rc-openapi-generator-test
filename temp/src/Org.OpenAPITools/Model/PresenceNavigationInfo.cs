...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PresenceNavigationInfo :  IEquatable<PresenceNavigationInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PresenceNavigationInfo" /> class.
        /// </summary>
        /// <param name="firstPage">firstPage.</param>
        /// <param name="nextPage">nextPage.</param>
        /// <param name="previousPage">previousPage.</param>
        /// <param name="lastPage">lastPage.</param>
        public PresenceNavigationInfo(PresenceNavigationInfoURI firstPage = default(PresenceNavigationInfoURI), PresenceNavigationInfoURI nextPage = default(PresenceNavigationInfoURI), PresenceNavigationInfoURI previousPage = default(PresenceNavigationInfoURI), PresenceNavigationInfoURI lastPage = default(PresenceNavigationInfoURI))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PresenceNavigationInfo {\n");
        ...
        {
            return this.Equals(input as PresenceNavigationInfo);
        }

        /// <summary>
        /// Returns true if PresenceNavigationInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of PresenceNavigationInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PresenceNavigationInfo input)
        {
            if (input == null)
                return false;
