...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DeviceEmergencyServiceAddressResource :  IEquatable<DeviceEmergencyServiceAddressResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceEmergencyServiceAddressResource" /> class.
        /// </summary>
        ...
        public DeviceEmergencyServiceAddressResource(string street = default(string), string street2 = default(string), string city = default(string), string zip = default(string), string customerName = default(string), string state = default(string), string stateId = default(string), string stateIsoCode = default(string), string stateName = default(string), string countryId = default(string), string countryIsoCode = default(string), string country = default(string), string countryName = default(string), bool outOfCountry = default(bool))
        {
            this.Street = street;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceEmergencyServiceAddressResource {\n");
        ...
        {
            return this.Equals(input as DeviceEmergencyServiceAddressResource);
        }

        /// <summary>
        /// Returns true if DeviceEmergencyServiceAddressResource instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceEmergencyServiceAddressResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceEmergencyServiceAddressResource input)
        {
            if (input == null)
                return false;
