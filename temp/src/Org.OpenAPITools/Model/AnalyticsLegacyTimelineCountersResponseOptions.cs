...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AnalyticsLegacyTimelineCountersResponseOptions :  IEquatable<AnalyticsLegacyTimelineCountersResponseOptions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AnalyticsLegacyTimelineCountersResponseOptions" /> class.
        /// </summary>
        ...
        /// </summary>
        /// <value>This counter is only applicable to Queues grouping</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AnalyticsLegacyTimelineCountersResponseOptions {\n");
        ...
        {
            return this.Equals(input as AnalyticsLegacyTimelineCountersResponseOptions);
        }

        /// <summary>
        /// Returns true if AnalyticsLegacyTimelineCountersResponseOptions instances are equal
        /// </summary>
        /// <param name="input">Instance of AnalyticsLegacyTimelineCountersResponseOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AnalyticsLegacyTimelineCountersResponseOptions input)
        {
            if (input == null)
                return false;
