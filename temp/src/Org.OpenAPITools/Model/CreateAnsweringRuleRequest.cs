...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateAnsweringRuleRequest :  IEquatable<CreateAnsweringRuleRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateAnsweringRuleRequest" /> class.
        /// </summary>
        /// <param name="enabled">Specifies if the rule is active or inactive. The default value is &#39;True&#39;.</param>
        /// <param name="type">Type of an answering rule. The &#39;Custom&#39; value should be specified.</param>
        ...
        public CreateAnsweringRuleRequest(bool enabled = default(bool), string type = default(string), string name = default(string), List<CallersInfoRequest> callers = default(List<CallersInfoRequest>), List<CalledNumberInfo> calledNumbers = default(List<CalledNumberInfo>), ScheduleInfo schedule = default(ScheduleInfo), CallHandlingActionEnum? callHandlingAction = default(CallHandlingActionEnum?), ForwardingInfo forwarding = default(ForwardingInfo), UnconditionalForwardingInfo unconditionalForwarding = default(UnconditionalForwardingInfo), QueueInfo queue = default(QueueInfo), TransferredExtensionInfo transfer = default(TransferredExtensionInfo), VoicemailInfo voicemail = default(VoicemailInfo), MissedCallInfo missedCall = default(MissedCallInfo), List<GreetingInfo> greetings = default(List<GreetingInfo>), ScreeningEnum? screening = default(ScreeningEnum?))
        {
        ...
        /// </summary>
        /// <value>Type of an answering rule. The &#39;Custom&#39; value should be specified</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateAnsweringRuleRequest {\n");
        ...
        {
            return this.Equals(input as CreateAnsweringRuleRequest);
        }

        /// <summary>
        /// Returns true if CreateAnsweringRuleRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateAnsweringRuleRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateAnsweringRuleRequest input)
        {
            if (input == null)
                return false;
