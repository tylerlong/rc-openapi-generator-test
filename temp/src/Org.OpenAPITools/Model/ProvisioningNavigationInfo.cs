...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProvisioningNavigationInfo :  IEquatable<ProvisioningNavigationInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProvisioningNavigationInfo" /> class.
        /// </summary>
        /// <param name="firstPage">firstPage.</param>
        /// <param name="nextPage">nextPage.</param>
        /// <param name="previousPage">previousPage.</param>
        /// <param name="lastPage">lastPage.</param>
        public ProvisioningNavigationInfo(ProvisioningNavigationInfoUri firstPage = default(ProvisioningNavigationInfoUri), ProvisioningNavigationInfoUri nextPage = default(ProvisioningNavigationInfoUri), ProvisioningNavigationInfoUri previousPage = default(ProvisioningNavigationInfoUri), ProvisioningNavigationInfoUri lastPage = default(ProvisioningNavigationInfoUri))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProvisioningNavigationInfo {\n");
        ...
        {
            return this.Equals(input as ProvisioningNavigationInfo);
        }

        /// <summary>
        /// Returns true if ProvisioningNavigationInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of ProvisioningNavigationInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProvisioningNavigationInfo input)
        {
            if (input == null)
                return false;
