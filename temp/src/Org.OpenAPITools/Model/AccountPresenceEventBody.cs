...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AccountPresenceEventBody :  IEquatable<AccountPresenceEventBody>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountPresenceEventBody" /> class.
        /// </summary>
        /// <param name="extensionId">Internal identifier of an extension. Optional parameter (default to &quot;~&quot;).</param>
        ...
        public AccountPresenceEventBody(string extensionId = "~", TelephonyStatusEnum? telephonyStatus = default(TelephonyStatusEnum?), int sequence = default(int), PresenceStatusEnum? presenceStatus = default(PresenceStatusEnum?), UserStatusEnum? userStatus = default(UserStatusEnum?), DndStatusEnum? dndStatus = default(DndStatusEnum?), bool allowSeeMyPresence = default(bool), bool ringOnMonitoredCall = default(bool), bool pickUpCallsOnHold = default(bool), string ownerId = default(string))
        {
        ...
        /// </summary>
        /// <value>Internal identifier of an extension. Optional parameter</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountPresenceEventBody {\n");
        ...
        {
            return this.Equals(input as AccountPresenceEventBody);
        }

        /// <summary>
        /// Returns true if AccountPresenceEventBody instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountPresenceEventBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountPresenceEventBody input)
        {
            if (input == null)
                return false;
