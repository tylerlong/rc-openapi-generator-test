...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MessagingPagingInfo :  IEquatable<MessagingPagingInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MessagingPagingInfo" /> class.
        /// </summary>
        ...
        public MessagingPagingInfo(int page = default(int), int perPage = default(int), int pageStart = default(int), int pageEnd = default(int), int totalPages = default(int), int totalElements = default(int))
        {
            this.Page = page;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MessagingPagingInfo {\n");
        ...
        {
            return this.Equals(input as MessagingPagingInfo);
        }

        /// <summary>
        /// Returns true if MessagingPagingInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of MessagingPagingInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MessagingPagingInfo input)
        {
            if (input == null)
                return false;
