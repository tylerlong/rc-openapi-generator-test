...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CompanyCallLogRecord :  IEquatable<CompanyCallLogRecord>, IValidatableObject
    {
        /// <summary>
        /// Call transport
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CompanyCallLogRecord" /> class.
        /// </summary>
        ...
        public CompanyCallLogRecord(string id = default(string), string uri = default(string), string sessionId = default(string), ExtensionInfoCallLog extension = default(ExtensionInfoCallLog), string telephonySessionId = default(string), TransportEnum? transport = default(TransportEnum?), CallLogCallerInfo from = default(CallLogCallerInfo), CallLogCallerInfo to = default(CallLogCallerInfo), TypeEnum? type = default(TypeEnum?), DirectionEnum? direction = default(DirectionEnum?), CallLogRecordMessage message = default(CallLogRecordMessage), CallLogDelegateInfo _delegate = default(CallLogDelegateInfo), bool deleted = default(bool), ActionEnum? action = default(ActionEnum?), ResultEnum? result = default(ResultEnum?), ReasonEnum? reason = default(ReasonEnum?), string reasonDescription = default(string), DateTime startTime = default(DateTime), int duration = default(int), CallLogRecordingInfo recording = default(CallLogRecordingInfo), bool shortRecording = default(bool), List<CallLogRecordLegInfo> legs = default(List<CallLogRecordLegInfo>), BillingInfo billing = default(BillingInfo), DateTime lastModifiedTime = default(DateTime), InternalTypeEnum? internalType = default(InternalTypeEnum?))
        {
            this.Id = id;
            this.Uri = uri;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CompanyCallLogRecord {\n");
        ...
        {
            return this.Equals(input as CompanyCallLogRecord);
        }

        /// <summary>
        /// Returns true if CompanyCallLogRecord instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyCallLogRecord to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyCallLogRecord input)
        {
            if (input == null)
                return false;
