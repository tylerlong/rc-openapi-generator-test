...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateWirelessPoint :  IEquatable<UpdateWirelessPoint>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateWirelessPoint" /> class.
        /// </summary>
        /// <param name="id">Internal identifier of a wireless point.</param>
        /// <param name="bssid">Unique 48-bit identifier of wireless access point complying with MAC address conventions. Mask: XX:XX:XX:XX:XX:XX, where X can be a symbol in the range of 0-9 or A-F.</param>
        ...
        /// </summary>
        /// <value>Unique 48-bit identifier of wireless access point complying with MAC address conventions. Mask: XX:XX:XX:XX:XX:XX, where X can be a symbol in the range of 0-9 or A-F</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateWirelessPoint {\n");
        ...
        {
            return this.Equals(input as UpdateWirelessPoint);
        }

        /// <summary>
        /// Returns true if UpdateWirelessPoint instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateWirelessPoint to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateWirelessPoint input)
        {
            if (input == null)
                return false;
