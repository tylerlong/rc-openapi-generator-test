...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GlipDataExportPagingInfo :  IEquatable<GlipDataExportPagingInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GlipDataExportPagingInfo" /> class.
        /// </summary>
        ...
        public GlipDataExportPagingInfo(int page = default(int), int perPage = default(int), int pageStart = default(int), int pageEnd = default(int), int totalPages = default(int), int totalElements = default(int))
        {
            this.Page = page;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GlipDataExportPagingInfo {\n");
        ...
        {
            return this.Equals(input as GlipDataExportPagingInfo);
        }

        /// <summary>
        /// Returns true if GlipDataExportPagingInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of GlipDataExportPagingInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GlipDataExportPagingInfo input)
        {
            if (input == null)
                return false;
