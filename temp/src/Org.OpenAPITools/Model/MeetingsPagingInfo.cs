...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MeetingsPagingInfo :  IEquatable<MeetingsPagingInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MeetingsPagingInfo" /> class.
        /// </summary>
        ...
        public MeetingsPagingInfo(int page = default(int), int totalPages = default(int), int perPage = default(int), int totalElements = default(int), int pageStart = default(int), int pageEnd = default(int))
        {
            this.Page = page;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MeetingsPagingInfo {\n");
        ...
        {
            return this.Equals(input as MeetingsPagingInfo);
        }

        /// <summary>
        /// Returns true if MeetingsPagingInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of MeetingsPagingInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MeetingsPagingInfo input)
        {
            if (input == null)
                return false;
