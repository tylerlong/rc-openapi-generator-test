...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FormattingLocaleInfo :  IEquatable<FormattingLocaleInfo>, IValidatableObject
    {
        /// <summary>
        ...
        public FormattingLocaleInfo(string id = default(string), string localeCode = default(string), string name = default(string))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as FormattingLocaleInfo);
        }

        /// <summary>
        /// Returns true if FormattingLocaleInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of FormattingLocaleInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FormattingLocaleInfo input)
        {
            if (input == null)
                return false;
