...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetStateListResponse :  IEquatable<GetStateListResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetStateListResponse" /> class.
        /// </summary>
        /// <param name="uri">Link to the states list resource.</param>
        /// <param name="records">List of states.</param>
        /// <param name="navigation">navigation.</param>
        /// <param name="paging">paging.</param>
        public GetStateListResponse(string uri = default(string), List<GetStateInfoResponse> records = default(List<GetStateInfoResponse>), ProvisioningNavigationInfo navigation = default(ProvisioningNavigationInfo), ProvisioningPagingInfo paging = default(ProvisioningPagingInfo))
        {
            this.Uri = uri;
        ...
        /// </summary>
        /// <value>Link to the states list resource</value>
        ...
        {
            return this.Equals(input as GetStateListResponse);
        }

        /// <summary>
        /// Returns true if GetStateListResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetStateListResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetStateListResponse input)
        {
            if (input == null)
                return false;
