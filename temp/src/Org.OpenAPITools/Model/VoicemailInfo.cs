...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class VoicemailInfo :  IEquatable<VoicemailInfo>, IValidatableObject
    {
        /// <summary>
        ...
        public VoicemailInfo(bool enabled = default(bool), RecipientInfo recipient = default(RecipientInfo))
        {
        ...
        {
            return this.Equals(input as VoicemailInfo);
        }

        /// <summary>
        /// Returns true if VoicemailInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of VoicemailInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VoicemailInfo input)
        {
            if (input == null)
                return false;
