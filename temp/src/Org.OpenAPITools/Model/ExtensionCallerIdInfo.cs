...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExtensionCallerIdInfo :  IEquatable<ExtensionCallerIdInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExtensionCallerIdInfo" /> class.
        /// </summary>
        ...
        public ExtensionCallerIdInfo(string uri = default(string), List<CallerIdByDevice> byDevice = default(List<CallerIdByDevice>), List<CallerIdByFeature> byFeature = default(List<CallerIdByFeature>), bool extensionNameForOutboundCalls = default(bool), bool extensionNumberForInternalCalls = default(bool))
        {
            this.Uri = uri;
        ...
        public List<CallerIdByDevice> ByDevice { get; set; }

        /// <summary>
        /// Gets or Sets ByFeature
        /// </summary>
        [DataMember(Name="byFeature", EmitDefaultValue=false)]
        public List<CallerIdByFeature> ByFeature { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExtensionCallerIdInfo {\n");
        ...
        {
            return this.Equals(input as ExtensionCallerIdInfo);
        }

        /// <summary>
        /// Returns true if ExtensionCallerIdInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of ExtensionCallerIdInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExtensionCallerIdInfo input)
        {
            if (input == null)
                return false;
