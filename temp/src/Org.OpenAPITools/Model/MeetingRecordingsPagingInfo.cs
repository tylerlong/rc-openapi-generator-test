...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MeetingRecordingsPagingInfo :  IEquatable<MeetingRecordingsPagingInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MeetingRecordingsPagingInfo" /> class.
        /// </summary>
        ...
        public MeetingRecordingsPagingInfo(int page = default(int), int perPage = default(int), int pageStart = default(int), int pageEnd = default(int), int totalPages = default(int), int totalElements = default(int))
        {
            this.Page = page;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MeetingRecordingsPagingInfo {\n");
        ...
        {
            return this.Equals(input as MeetingRecordingsPagingInfo);
        }

        /// <summary>
        /// Returns true if MeetingRecordingsPagingInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of MeetingRecordingsPagingInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MeetingRecordingsPagingInfo input)
        {
            if (input == null)
                return false;
