...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ContactInfo :  IEquatable<ContactInfo>, IValidatableObject
    {
        ...
        /// <param name="name">Extension user name (first name and last name).</param>
        /// <param name="company">Extension user company name.</param>
        /// <param name="jobTitle">jobTitle.</param>
        /// <param name="email">Email of extension user.</param>
        /// <param name="businessPhone">Extension user contact phone number in [E.164](https://www.itu.int/rec/T-REC-E.164-201011-I) (with &#39;+&#39; sign) format.</param>
        ...
        /// <param name="emailAsLoginName">If &#39;True&#39; then contact email is enabled as login name for this user. Please note that email should be unique in this case. (default to false).</param>
        /// <param name="pronouncedName">pronouncedName.</param>
        /// <param name="department">Extension user department, if any.</param>
        public ContactInfo(string firstName = default(string), string lastName = default(string), string name = default(string), string company = default(string), string jobTitle = default(string), string email = default(string), string businessPhone = default(string), string mobilePhone = default(string), ContactBusinessAddressInfo businessAddress = default(ContactBusinessAddressInfo), bool emailAsLoginName = false, PronouncedNameInfo pronouncedName = default(PronouncedNameInfo), string department = default(string))
        {
            ...
            // use default value if no "emailAsLoginName" provided
            if (emailAsLoginName == null)
            {
                this.EmailAsLoginName = false;
            }
            else
            {
        ...
        /// </summary>
        /// <value>Extension user name (first name and last name)</value>
        ...
        /// </summary>
        /// <value>Extension user contact phone number in [E.164](https://www.itu.int/rec/T-REC-E.164-201011-I) (with &#39;+&#39; sign) format</value>
        ...
        /// </summary>
        /// <value>If &#39;True&#39; then contact email is enabled as login name for this user. Please note that email should be unique in this case.</value>
