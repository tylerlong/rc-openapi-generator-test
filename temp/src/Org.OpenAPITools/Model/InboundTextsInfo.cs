...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InboundTextsInfo :  IEquatable<InboundTextsInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InboundTextsInfo" /> class.
        /// </summary>
        /// <param name="notifyByEmail">Email notification flag.</param>
        /// <param name="notifyBySms">SMS notification flag.</param>
        /// <param name="advancedEmailAddresses">List of recipient email addresses for inbound text message notifications. Returned if specified, in both modes (advanced/basic). Applied in advanced mode only.</param>
        /// <param name="advancedSmsEmailAddresses">List of recipient phone numbers for inbound text message notifications. Returned if specified, in both modes (advanced/basic). Applied in advanced mode only.</param>
        public InboundTextsInfo(bool notifyByEmail = default(bool), bool notifyBySms = default(bool), List<string> advancedEmailAddresses = default(List<string>), List<string> advancedSmsEmailAddresses = default(List<string>))
        {
        ...
        /// </summary>
        /// <value>List of recipient email addresses for inbound text message notifications. Returned if specified, in both modes (advanced/basic). Applied in advanced mode only</value>
        ...
        /// </summary>
        /// <value>List of recipient phone numbers for inbound text message notifications. Returned if specified, in both modes (advanced/basic). Applied in advanced mode only</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InboundTextsInfo {\n");
        ...
        {
            return this.Equals(input as InboundTextsInfo);
        }

        /// <summary>
        /// Returns true if InboundTextsInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of InboundTextsInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InboundTextsInfo input)
        {
            if (input == null)
                return false;
