...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PrivateIpRangeInfo :  IEquatable<PrivateIpRangeInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PrivateIpRangeInfo" /> class.
        /// </summary>
        ...
        public PrivateIpRangeInfo(string id = default(string), string startIp = default(string), string endIp = default(string), string name = default(string), LocationUpdatesEmergencyAddressInfo emergencyAddress = default(LocationUpdatesEmergencyAddressInfo), string emergencyLocationId = default(string), bool matched = default(bool))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PrivateIpRangeInfo {\n");
        ...
        {
            return this.Equals(input as PrivateIpRangeInfo);
        }

        /// <summary>
        /// Returns true if PrivateIpRangeInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of PrivateIpRangeInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PrivateIpRangeInfo input)
        {
            if (input == null)
                return false;
