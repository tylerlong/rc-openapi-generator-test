...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class BackgroundImage :  IEquatable<BackgroundImage>, IValidatableObject
    {
        ...
        public BackgroundImage(TypeEnum? type = default(TypeEnum?), string url = default(string), ImageFillMode fillMode = default(ImageFillMode), HorizontalAlignment horizontalAlignment = default(HorizontalAlignment), VerticalAlignment verticalAlignment = default(VerticalAlignment))
        {
            // to ensure "url" is required (not null)
            if (url == null)
            {
                throw new InvalidDataException("url is a required property for BackgroundImage and cannot be null");
            }
            else
            {
                this.Url = url;
