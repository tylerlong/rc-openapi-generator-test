...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserContactsPagingInfo :  IEquatable<UserContactsPagingInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserContactsPagingInfo" /> class.
        /// </summary>
        ...
        public UserContactsPagingInfo(int page = default(int), int perPage = default(int), int pageStart = default(int), int pageEnd = default(int), int totalPages = default(int), int totalElements = default(int))
        {
            this.Page = page;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserContactsPagingInfo {\n");
        ...
        {
            return this.Equals(input as UserContactsPagingInfo);
        }

        /// <summary>
        /// Returns true if UserContactsPagingInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of UserContactsPagingInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserContactsPagingInfo input)
        {
            if (input == null)
                return false;
