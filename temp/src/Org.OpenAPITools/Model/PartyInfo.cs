...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PartyInfo :  IEquatable<PartyInfo>, IValidatableObject
    {
        /// <summary>
        ...
        public PartyInfo(string phoneNumber = default(string), string name = default(string), string deviceId = default(string), string extensionId = default(string))
        {
