...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GlipGroupInfo :  IEquatable<GlipGroupInfo>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GlipGroupInfo" /> class.
        /// </summary>
        ...
        public GlipGroupInfo(string id = default(string), TypeEnum? type = default(TypeEnum?), bool isPublic = default(bool), string name = default(string), string description = default(string), List<string> members = default(List<string>), DateTime creationTime = default(DateTime), DateTime lastModifiedTime = default(DateTime))
        {
            this.Id = id;
            this.Type = type;
        ...
        {
            return this.Equals(input as GlipGroupInfo);
        }

        /// <summary>
        /// Returns true if GlipGroupInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of GlipGroupInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GlipGroupInfo input)
        {
            if (input == null)
                return false;
