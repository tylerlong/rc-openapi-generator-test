...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CallsCounters :  IEquatable<CallsCounters>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CallsCounters" /> class.
        /// </summary>
        ...
        public CallsCounters(AllCalls allCalls = default(AllCalls), CallsByDirection callsByDirection = default(CallsByDirection), CallsByOrigin callsByOrigin = default(CallsByOrigin), CallsByResponse callsByResponse = default(CallsByResponse), CallsBySegments callsSegments = default(CallsBySegments), CallsByResult callsByResult = default(CallsByResult), CallsByActions callsActions = default(CallsByActions), CallsByCompanyHours callsByCompanyHours = default(CallsByCompanyHours), CallsByQueueSla callsByQueueSla = default(CallsByQueueSla), CallsByType callsByType = default(CallsByType))
        {
        ...
        {
            return this.Equals(input as CallsCounters);
        }

        /// <summary>
        /// Returns true if CallsCounters instances are equal
        /// </summary>
        /// <param name="input">Instance of CallsCounters to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallsCounters input)
        {
            if (input == null)
                return false;
