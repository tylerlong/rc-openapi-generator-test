...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class TimeRange :  IEquatable<TimeRange>, IValidatableObject
    {
        ...
        public TimeRange(DateTime timeFrom = default(DateTime), DateTime timeTo = default(DateTime))
        {
            // to ensure "timeFrom" is required (not null)
            if (timeFrom == null)
            {
                throw new InvalidDataException("timeFrom is a required property for TimeRange and cannot be null");
            }
            else
            {
            ...
            if (timeTo == null)
            {
                throw new InvalidDataException("timeTo is a required property for TimeRange and cannot be null");
            }
            else
            {
                this.TimeTo = timeTo;
