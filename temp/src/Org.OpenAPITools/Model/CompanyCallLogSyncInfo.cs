...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CompanyCallLogSyncInfo :  IEquatable<CompanyCallLogSyncInfo>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CompanyCallLogSyncInfo" /> class.
        /// </summary>
        /// <param name="syncType">Type of synchronization.</param>
        /// <param name="syncToken">Synchronization token.</param>
        /// <param name="syncTime">Time of last synchronization in (ISO 8601)[https://en.wikipedia.org/wiki/ISO_8601] format including timezone, for example *2016-03-10T18:07:52.534Z*.</param>
        public CompanyCallLogSyncInfo(SyncTypeEnum? syncType = default(SyncTypeEnum?), string syncToken = default(string), string syncTime = default(string))
        {
        ...
        /// </summary>
        /// <value>Time of last synchronization in (ISO 8601)[https://en.wikipedia.org/wiki/ISO_8601] format including timezone, for example *2016-03-10T18:07:52.534Z*</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CompanyCallLogSyncInfo {\n");
        ...
        {
            return this.Equals(input as CompanyCallLogSyncInfo);
        }

        /// <summary>
        /// Returns true if CompanyCallLogSyncInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyCallLogSyncInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyCallLogSyncInfo input)
        {
            if (input == null)
                return false;
