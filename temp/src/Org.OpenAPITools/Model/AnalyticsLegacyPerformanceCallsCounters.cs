...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AnalyticsLegacyPerformanceCallsCounters :  IEquatable<AnalyticsLegacyPerformanceCallsCounters>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AnalyticsLegacyPerformanceCallsCounters" /> class.
        /// </summary>
        ...
        /// <param name="callsActions">callsActions.</param>
        ...
        public AnalyticsLegacyPerformanceCallsCounters(AnalyticsLegacyPerformanceCallsTotal allCalls = default(AnalyticsLegacyPerformanceCallsTotal), AnalyticsLegacyPerformanceCallsByDirection callsByDirection = default(AnalyticsLegacyPerformanceCallsByDirection), AnalyticsLegacyPerformanceCallsByOrigin callsByOrigin = default(AnalyticsLegacyPerformanceCallsByOrigin), AnalyticsLegacyPerformanceCallsByResponse callsByResponse = default(AnalyticsLegacyPerformanceCallsByResponse), AnalyticsLegacyPerformanceCallsSegments callsSegments = default(AnalyticsLegacyPerformanceCallsSegments), AnalyticsLegacyPerformanceCallsByResult callsByResult = default(AnalyticsLegacyPerformanceCallsByResult), AnalyticsLegacyPerformanceCallsActions callsActions = default(AnalyticsLegacyPerformanceCallsActions), AnalyticsLegacyPerformanceCallsByCompanyHours callsByCompanyHours = default(AnalyticsLegacyPerformanceCallsByCompanyHours), AnalyticsLegacyPerformanceCallsByQueueSla callsByQueueSla = default(AnalyticsLegacyPerformanceCallsByQueueSla), AnalyticsLegacyPerformanceCallsByType callsByType = default(AnalyticsLegacyPerformanceCallsByType))
        {
        ...
        /// <summary>
        /// Gets or Sets CallsActions
        /// </summary>
        [DataMember(Name="callsActions", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AnalyticsLegacyPerformanceCallsCounters {\n");
            ...
            sb.Append("  CallsActions: ").Append(CallsActions).Append("\n");
        ...
        {
            return this.Equals(input as AnalyticsLegacyPerformanceCallsCounters);
        }

        /// <summary>
        /// Returns true if AnalyticsLegacyPerformanceCallsCounters instances are equal
        /// </summary>
        /// <param name="input">Instance of AnalyticsLegacyPerformanceCallsCounters to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AnalyticsLegacyPerformanceCallsCounters input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.CallsActions == input.CallsActions ||
                    (this.CallsActions != null &&
                    this.CallsActions.Equals(input.CallsActions))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CallsActions != null)
                    hashCode = hashCode * 59 + this.CallsActions.GetHashCode();
