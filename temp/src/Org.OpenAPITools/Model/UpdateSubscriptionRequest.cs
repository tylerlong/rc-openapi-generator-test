...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class UpdateSubscriptionRequest :  IEquatable<UpdateSubscriptionRequest>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="UpdateSubscriptionRequest" /> class.
        /// </summary>
        /// <param name="eventFilters">The list of event filters corresponding to events the user is subscribed to (required).</param>
        ...
        public UpdateSubscriptionRequest(List<string> eventFilters = default(List<string>), int expiresIn = default(int))
        {
            // to ensure "eventFilters" is required (not null)
            if (eventFilters == null)
            {
                throw new InvalidDataException("eventFilters is a required property for UpdateSubscriptionRequest and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>The list of event filters corresponding to events the user is subscribed to</value>
