...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ValidationError :  IEquatable<ValidationError>, IValidatableObject
    {
        ...
        public ValidationError(string errorCode = default(string), string message = default(string), string parameterName = default(string), string featureName = default(string), string parameterValue = default(string))
        {
