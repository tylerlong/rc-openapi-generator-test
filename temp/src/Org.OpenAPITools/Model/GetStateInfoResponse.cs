...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetStateInfoResponse :  IEquatable<GetStateInfoResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public GetStateInfoResponse(string id = default(string), string uri = default(string), GetCountryInfoState country = default(GetCountryInfoState), string isoCode = default(string), string name = default(string))
        {
            this.Id = id;
            this.Uri = uri;
        ...
        {
            return this.Equals(input as GetStateInfoResponse);
        }

        /// <summary>
        /// Returns true if GetStateInfoResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetStateInfoResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetStateInfoResponse input)
        {
            if (input == null)
                return false;
