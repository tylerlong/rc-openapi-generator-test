...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DepartmentInfo :  IEquatable<DepartmentInfo>, IValidatableObject
    {
        /// <summary>
        ...
        public DepartmentInfo(string id = default(string), string uri = default(string), string extensionNumber = default(string))
        {
            this.Id = id;
            this.Uri = uri;
        ...
        {
            return this.Equals(input as DepartmentInfo);
        }

        /// <summary>
        /// Returns true if DepartmentInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of DepartmentInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DepartmentInfo input)
        {
            if (input == null)
                return false;
