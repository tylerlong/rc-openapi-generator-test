...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CallQueueExtensionInfo :  IEquatable<CallQueueExtensionInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CallQueueExtensionInfo" /> class.
        /// </summary>
        ...
        /// <param name="slaThresholdSeconds">Period of time in seconds that is considered to be an acceptable service level.</param>
        /// <param name="includeAbandonedCalls">If &#39;True&#39; abandoned calls (hanged up prior to being served) are included into service level calculation.</param>
        /// <param name="abandonedThresholdSeconds">Period of time in seconds specifying abandoned calls duration - calls that are shorter will not be included into the calculation of service level.; zero value means that abandoned calls of any duration will be included into calculation.</param>
        public CallQueueExtensionInfo(int slaGoal = default(int), int slaThresholdSeconds = default(int), bool includeAbandonedCalls = default(bool), int abandonedThresholdSeconds = default(int))
        {
        ...
        /// </summary>
        /// <value>Period of time in seconds that is considered to be an acceptable service level</value>
        ...
        /// </summary>
        /// <value>If &#39;True&#39; abandoned calls (hanged up prior to being served) are included into service level calculation</value>
        ...
        /// </summary>
        /// <value>Period of time in seconds specifying abandoned calls duration - calls that are shorter will not be included into the calculation of service level.; zero value means that abandoned calls of any duration will be included into calculation</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CallQueueExtensionInfo {\n");
        ...
        {
            return this.Equals(input as CallQueueExtensionInfo);
        }

        /// <summary>
        /// Returns true if CallQueueExtensionInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of CallQueueExtensionInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallQueueExtensionInfo input)
        {
            if (input == null)
                return false;
