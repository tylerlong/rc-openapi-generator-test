...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateSwitchInfo :  IEquatable<CreateSwitchInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSwitchInfo" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateSwitchInfo() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSwitchInfo" /> class.
        /// </summary>
        /// <param name="chassisId">Unique identifier of a network switch. The supported formats are: XX:XX:XX:XX:XX:XX (symbols 0-9 and A-F) for MAC address and X.X.X.X for IP address (symbols 0-255) (required).</param>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateSwitchInfo {\n");
        ...
        {
            return this.Equals(input as CreateSwitchInfo);
        }

        /// <summary>
        /// Returns true if CreateSwitchInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateSwitchInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateSwitchInfo input)
        {
            if (input == null)
                return false;
