...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MessageBody :  IEquatable<MessageBody>, IValidatableObject
    {
        /// <summary>
        ...
        public MessageBody(string uri = default(string), string id = default(string), List<MessageAttachmentInfo> attachments = default(List<MessageAttachmentInfo>), AvailabilityEnum? availability = default(AvailabilityEnum?), long conversationId = default(long), ConversationInfo conversation = default(ConversationInfo), DateTime creationTime = default(DateTime), string deliveryErrorCode = default(string), DirectionEnum? direction = default(DirectionEnum?), int faxPageCount = default(int), FaxResolutionEnum? faxResolution = default(FaxResolutionEnum?), MessageSenderInfo from = default(MessageSenderInfo), DateTime lastModifiedTime = default(DateTime), MessageStatusEnum? messageStatus = default(MessageStatusEnum?), bool pgToDepartment = default(bool), PriorityEnum? priority = default(PriorityEnum?), ReadStatusEnum? readStatus = default(ReadStatusEnum?), DateTime smsDeliveryTime = default(DateTime), int smsSendingAttemptsCount = default(int), string subject = default(string), List<MessageRecipientInfo> to = default(List<MessageRecipientInfo>), TypeEnum? type = default(TypeEnum?), VmTranscriptionStatusEnum? vmTranscriptionStatus = default(VmTranscriptionStatusEnum?))
        {
            this.Uri = uri;
            this.Id = id;
        ...
        public List<MessageRecipientInfo> To { get; set; }
        ...
        {
            return this.Equals(input as MessageBody);
        }

        /// <summary>
        /// Returns true if MessageBody instances are equal
        /// </summary>
        /// <param name="input">Instance of MessageBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MessageBody input)
        {
            if (input == null)
                return false;
