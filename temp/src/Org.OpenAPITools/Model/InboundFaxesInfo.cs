...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InboundFaxesInfo :  IEquatable<InboundFaxesInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InboundFaxesInfo" /> class.
        /// </summary>
        /// <param name="notifyByEmail">Email notification flag.</param>
        /// <param name="notifyBySms">SMS notification flag.</param>
        /// <param name="advancedEmailAddresses">List of recipient email addresses for inbound fax notifications. Returned if specified, in both modes (advanced/basic). Applied in advanced mode only.</param>
        /// <param name="advancedSmsEmailAddresses">List of recipient phone numbers for inbound fax notifications. Returned if specified, in both modes (advanced/basic). Applied in advanced mode only.</param>
        /// <param name="includeAttachment">Indicates whether fax should be attached to email.</param>
        /// <param name="markAsRead">Indicates whether email should be automatically marked as read.</param>
        public InboundFaxesInfo(bool notifyByEmail = default(bool), bool notifyBySms = default(bool), List<string> advancedEmailAddresses = default(List<string>), List<string> advancedSmsEmailAddresses = default(List<string>), bool includeAttachment = default(bool), bool markAsRead = default(bool))
        {
        ...
        /// </summary>
        /// <value>List of recipient email addresses for inbound fax notifications. Returned if specified, in both modes (advanced/basic). Applied in advanced mode only</value>
        ...
        /// </summary>
        /// <value>List of recipient phone numbers for inbound fax notifications. Returned if specified, in both modes (advanced/basic). Applied in advanced mode only</value>
        ...
        /// </summary>
        /// <value>Indicates whether fax should be attached to email</value>
        ...
        /// </summary>
        /// <value>Indicates whether email should be automatically marked as read</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InboundFaxesInfo {\n");
        ...
        {
            return this.Equals(input as InboundFaxesInfo);
        }

        /// <summary>
        /// Returns true if InboundFaxesInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of InboundFaxesInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InboundFaxesInfo input)
        {
            if (input == null)
                return false;
