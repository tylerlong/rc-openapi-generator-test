...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AggregationRequest :  IEquatable<AggregationRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public AggregationRequest(Grouping grouping = default(Grouping), TimeSettings timeSettings = default(TimeSettings), CallFilters callFilters = default(CallFilters), AggregationResponseOptions responseOptions = default(AggregationResponseOptions))
        {
            // to ensure "grouping" is required (not null)
            if (grouping == null)
            {
                throw new InvalidDataException("grouping is a required property for AggregationRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("timeSettings is a required property for AggregationRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("responseOptions is a required property for AggregationRequest and cannot be null");
            }
            else
            {
