...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CallerBlockingSettingsUpdate :  IEquatable<CallerBlockingSettingsUpdate>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CallerBlockingSettingsUpdate" /> class.
        /// </summary>
        ...
        public CallerBlockingSettingsUpdate(ModeEnum? mode = default(ModeEnum?), NoCallerIdEnum? noCallerId = default(NoCallerIdEnum?), PayPhonesEnum? payPhones = default(PayPhonesEnum?), List<BlockedCallerGreetingInfo> greetings = default(List<BlockedCallerGreetingInfo>))
        {
            this.Mode = mode;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CallerBlockingSettingsUpdate {\n");
        ...
        {
            return this.Equals(input as CallerBlockingSettingsUpdate);
        }

        /// <summary>
        /// Returns true if CallerBlockingSettingsUpdate instances are equal
        /// </summary>
        /// <param name="input">Instance of CallerBlockingSettingsUpdate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallerBlockingSettingsUpdate input)
        {
            if (input == null)
                return false;
