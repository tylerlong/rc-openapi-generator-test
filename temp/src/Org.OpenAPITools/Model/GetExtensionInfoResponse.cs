...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetExtensionInfoResponse :  IEquatable<GetExtensionInfoResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="departments">Information on department extension(s), to which the requested extension belongs. Returned only for user extensions, members of department, requested by single extensionId. Please note that legacy &#39;Department&#39; extension type corresponds to &#39;Call Queue&#39; extensions in modern RingCentral product terminology.</param>
        /// <param name="extensionNumber">Number of extension.</param>
        /// <param name="extensionNumbers">extensionNumbers.</param>
        ...
        public GetExtensionInfoResponse(long id = default(long), string uri = default(string), GetExtensionAccountInfo account = default(GetExtensionAccountInfo), ContactInfo contact = default(ContactInfo), List<CustomFieldInfo> customFields = default(List<CustomFieldInfo>), List<DepartmentInfo> departments = default(List<DepartmentInfo>), string extensionNumber = default(string), List<string> extensionNumbers = default(List<string>), string name = default(string), string partnerId = default(string), ExtensionPermissions permissions = default(ExtensionPermissions), ProfileImageInfo profileImage = default(ProfileImageInfo), List<ReferenceInfo> references = default(List<ReferenceInfo>), List<Roles> roles = default(List<Roles>), RegionalSettings regionalSettings = default(RegionalSettings), List<ExtensionServiceFeatureInfo> serviceFeatures = default(List<ExtensionServiceFeatureInfo>), SetupWizardStateEnum? setupWizardState = SetupWizardStateEnum.NotStarted, StatusEnum? status = default(StatusEnum?), ExtensionStatusInfo statusInfo = default(ExtensionStatusInfo), TypeEnum? type = default(TypeEnum?), SubTypeEnum? subType = default(SubTypeEnum?), CallQueueExtensionInfo callQueueInfo = default(CallQueueExtensionInfo), bool hidden = default(bool), AutomaticLocationUpdatesSiteInfo site = default(AutomaticLocationUpdatesSiteInfo))
        {
            this.Id = id;
            this.Uri = uri;
        ...
        /// </summary>
        /// <value>Information on department extension(s), to which the requested extension belongs. Returned only for user extensions, members of department, requested by single extensionId. Please note that legacy &#39;Department&#39; extension type corresponds to &#39;Call Queue&#39; extensions in modern RingCentral product terminology</value>
        ...
        /// <summary>
        /// Gets or Sets ExtensionNumbers
        /// </summary>
        [DataMember(Name="extensionNumbers", EmitDefaultValue=false)]
        public List<string> ExtensionNumbers { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ExtensionNumbers: ").Append(ExtensionNumbers).Append("\n");
        ...
        {
            return this.Equals(input as GetExtensionInfoResponse);
        }

        /// <summary>
        /// Returns true if GetExtensionInfoResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetExtensionInfoResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetExtensionInfoResponse input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ExtensionNumbers == input.ExtensionNumbers ||
                    this.ExtensionNumbers != null &&
                    input.ExtensionNumbers != null &&
                    this.ExtensionNumbers.SequenceEqual(input.ExtensionNumbers)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ExtensionNumbers != null)
                    hashCode = hashCode * 59 + this.ExtensionNumbers.GetHashCode();
                if (this.Name != null)
