...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MeetingsNavigationInfo :  IEquatable<MeetingsNavigationInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MeetingsNavigationInfo" /> class.
        /// </summary>
        /// <param name="nextPage">nextPage.</param>
        /// <param name="previousPage">previousPage.</param>
        /// <param name="firstPage">firstPage.</param>
        /// <param name="lastPage">lastPage.</param>
        public MeetingsNavigationInfo(MeetingsNavigationInfoUri nextPage = default(MeetingsNavigationInfoUri), MeetingsNavigationInfoUri previousPage = default(MeetingsNavigationInfoUri), MeetingsNavigationInfoUri firstPage = default(MeetingsNavigationInfoUri), MeetingsNavigationInfoUri lastPage = default(MeetingsNavigationInfoUri))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MeetingsNavigationInfo {\n");
        ...
        {
            return this.Equals(input as MeetingsNavigationInfo);
        }

        /// <summary>
        /// Returns true if MeetingsNavigationInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of MeetingsNavigationInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MeetingsNavigationInfo input)
        {
            if (input == null)
                return false;
