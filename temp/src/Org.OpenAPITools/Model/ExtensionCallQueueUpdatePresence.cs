...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExtensionCallQueueUpdatePresence :  IEquatable<ExtensionCallQueueUpdatePresence>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExtensionCallQueueUpdatePresence" /> class.
        /// </summary>
        /// <param name="callQueue">callQueue.</param>
        /// <param name="acceptCalls">Call queue agent availability for calls of this queue.</param>
        public ExtensionCallQueueUpdatePresence(CallQueueId callQueue = default(CallQueueId), bool acceptCalls = default(bool))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExtensionCallQueueUpdatePresence {\n");
        ...
        {
            return this.Equals(input as ExtensionCallQueueUpdatePresence);
        }

        /// <summary>
        /// Returns true if ExtensionCallQueueUpdatePresence instances are equal
        /// </summary>
        /// <param name="input">Instance of ExtensionCallQueueUpdatePresence to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExtensionCallQueueUpdatePresence input)
        {
            if (input == null)
                return false;
