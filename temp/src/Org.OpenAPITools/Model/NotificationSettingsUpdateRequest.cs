...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class NotificationSettingsUpdateRequest :  IEquatable<NotificationSettingsUpdateRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NotificationSettingsUpdateRequest" /> class.
        /// </summary>
        /// <param name="emailAddresses">List of notification recipient email addresses. Should not be empty if &#39;includeManagers&#39; parameter is set to false.</param>
        ...
        /// <param name="includeManagers">Specifies if managers&#39; emails are included in the list of emails to which notifications are sent. If not specified, then the value is &#39;True&#39; (default to true).</param>
        public NotificationSettingsUpdateRequest(List<string> emailAddresses = default(List<string>), List<string> smsEmailAddresses = default(List<string>), bool advancedMode = default(bool), VoicemailsInfo voicemails = default(VoicemailsInfo), InboundFaxesInfo inboundFaxes = default(InboundFaxesInfo), OutboundFaxesInfo outboundFaxes = default(OutboundFaxesInfo), InboundTextsInfo inboundTexts = default(InboundTextsInfo), MissedCallsInfo missedCalls = default(MissedCallsInfo), bool includeManagers = true)
        {
            ...
            // use default value if no "includeManagers" provided
            if (includeManagers == null)
            {
        ...
        /// </summary>
        /// <value>List of notification recipient email addresses. Should not be empty if &#39;includeManagers&#39; parameter is set to false</value>
        ...
        /// </summary>
        /// <value>Specifies if managers&#39; emails are included in the list of emails to which notifications are sent. If not specified, then the value is &#39;True&#39;</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NotificationSettingsUpdateRequest {\n");
        ...
        {
            return this.Equals(input as NotificationSettingsUpdateRequest);
        }

        /// <summary>
        /// Returns true if NotificationSettingsUpdateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of NotificationSettingsUpdateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NotificationSettingsUpdateRequest input)
        {
            if (input == null)
                return false;
