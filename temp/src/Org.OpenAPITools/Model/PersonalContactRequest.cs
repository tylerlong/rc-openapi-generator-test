...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PersonalContactRequest :  IEquatable<PersonalContactRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PersonalContactRequest" /> class.
        /// </summary>
        ...
        public PersonalContactRequest(string firstName = default(string), string lastName = default(string), string middleName = default(string), string nickName = default(string), string company = default(string), string jobTitle = default(string), string email = default(string), string email2 = default(string), string email3 = default(string), DateTime birthday = default(DateTime), string webPage = default(string), string notes = default(string), string homePhone = default(string), string homePhone2 = default(string), string businessPhone = default(string), string businessPhone2 = default(string), string mobilePhone = default(string), string businessFax = default(string), string companyPhone = default(string), string assistantPhone = default(string), string carPhone = default(string), string otherPhone = default(string), string otherFax = default(string), string callbackPhone = default(string), ContactAddressInfo homeAddress = default(ContactAddressInfo), ContactAddressInfo businessAddress = default(ContactAddressInfo), ContactAddressInfo otherAddress = default(ContactAddressInfo), string ringtoneIndex = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PersonalContactRequest {\n");
        ...
        {
            return this.Equals(input as PersonalContactRequest);
        }

        /// <summary>
        /// Returns true if PersonalContactRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PersonalContactRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PersonalContactRequest input)
        {
            if (input == null)
                return false;
