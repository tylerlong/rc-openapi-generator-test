...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GlipAdaptiveCardRequestBackgroundImage :  IEquatable<GlipAdaptiveCardRequestBackgroundImage>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GlipAdaptiveCardRequestBackgroundImage" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GlipAdaptiveCardRequestBackgroundImage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GlipAdaptiveCardRequestBackgroundImage" /> class.
        /// </summary>
        ...
        public GlipAdaptiveCardRequestBackgroundImage(TypeEnum? type = default(TypeEnum?), string url = default(string), ImageFillMode fillMode = default(ImageFillMode), HorizontalAlignment horizontalAlignment = default(HorizontalAlignment), VerticalAlignment verticalAlignment = default(VerticalAlignment))
        {
            // to ensure "url" is required (not null)
            if (url == null)
            {
                throw new InvalidDataException("url is a required property for GlipAdaptiveCardRequestBackgroundImage and cannot be null");
            }
            else
            {
                this.Url = url;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GlipAdaptiveCardRequestBackgroundImage {\n");
        ...
        {
            return this.Equals(input as GlipAdaptiveCardRequestBackgroundImage);
        }

        /// <summary>
        /// Returns true if GlipAdaptiveCardRequestBackgroundImage instances are equal
        /// </summary>
        /// <param name="input">Instance of GlipAdaptiveCardRequestBackgroundImage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GlipAdaptiveCardRequestBackgroundImage input)
        {
            if (input == null)
                return false;
