...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SupervisePartyFrom :  IEquatable<SupervisePartyFrom>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SupervisePartyFrom" /> class.
        /// </summary>
        ...
        public SupervisePartyFrom(string phoneNumber = default(string), string name = default(string), string deviceId = default(string), string extensionId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SupervisePartyFrom {\n");
        ...
        {
            return this.Equals(input as SupervisePartyFrom);
        }

        /// <summary>
        /// Returns true if SupervisePartyFrom instances are equal
        /// </summary>
        /// <param name="input">Instance of SupervisePartyFrom to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SupervisePartyFrom input)
        {
            if (input == null)
                return false;
