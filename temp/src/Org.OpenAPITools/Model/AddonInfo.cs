...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AddonInfo :  IEquatable<AddonInfo>, IValidatableObject
    {
        /// <summary>
        ...
        public AddonInfo(string id = default(string), string name = default(string), int count = default(int))
        {
            this.Id = id;
            this.Name = name;
            this.Count = count;
