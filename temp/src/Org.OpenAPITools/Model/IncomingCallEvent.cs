...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class IncomingCallEvent :  IEquatable<IncomingCallEvent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IncomingCallEvent" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IncomingCallEvent {\n");
        ...
        {
            return this.Equals(input as IncomingCallEvent);
        }

        /// <summary>
        /// Returns true if IncomingCallEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of IncomingCallEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IncomingCallEvent input)
        {
            if (input == null)
                return false;
