...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DeviceEmergencyInfo :  IEquatable<DeviceEmergencyInfo>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceEmergencyInfo" /> class.
        /// </summary>
        ...
        /// <param name="visibility">Visibility of an emergency response location. If &#x60;Private&#x60; is set, then location is visible only for the restricted number of users, specified in &#x60;owners&#x60; array.</param>
        ...
        public DeviceEmergencyInfo(DeviceEmergencyAddress address = default(DeviceEmergencyAddress), DeviceEmergencyLocationInfo location = default(DeviceEmergencyLocationInfo), bool outOfCountry = default(bool), AddressStatusEnum? addressStatus = default(AddressStatusEnum?), VisibilityEnum? visibility = default(VisibilityEnum?), SyncStatusEnum? syncStatus = default(SyncStatusEnum?), AddressEditableStatusEnum? addressEditableStatus = default(AddressEditableStatusEnum?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceEmergencyInfo {\n");
        ...
        {
            return this.Equals(input as DeviceEmergencyInfo);
        }

        /// <summary>
        /// Returns true if DeviceEmergencyInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceEmergencyInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceEmergencyInfo input)
        {
            if (input == null)
                return false;
