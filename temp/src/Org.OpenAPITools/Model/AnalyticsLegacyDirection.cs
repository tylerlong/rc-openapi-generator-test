...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    /// <value>Specifies whether the call was inbound or outbound relative to the scope specified in grouping object. Not applicable to internal calls with company scope (when grouping is not specified)</value>
    
    [JsonConverter(typeof(StringEnumConverter))]
    
    public enum AnalyticsLegacyDirection
    {
        /// <summary>
