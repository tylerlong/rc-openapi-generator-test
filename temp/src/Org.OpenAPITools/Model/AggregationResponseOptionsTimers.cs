...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AggregationResponseOptionsTimers :  IEquatable<AggregationResponseOptionsTimers>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AggregationResponseOptionsTimers" /> class.
        /// </summary>
        ...
        public AggregationResponseOptionsTimers(AggregationResponseOptionsTimersAllCallsDuration allCallsDuration = default(AggregationResponseOptionsTimersAllCallsDuration), AggregationResponseOptionsTimersCallsDurationByDirection callsDurationByDirection = default(AggregationResponseOptionsTimersCallsDurationByDirection), AggregationResponseOptionsTimersCallsDurationByOrigin callsDurationByOrigin = default(AggregationResponseOptionsTimersCallsDurationByOrigin), AggregationResponseOptionsTimersCallsDurationByResponse callsDurationByResponse = default(AggregationResponseOptionsTimersCallsDurationByResponse), AggregationResponseOptionsTimersCallsSegmentsDuration callsSegmentsDuration = default(AggregationResponseOptionsTimersCallsSegmentsDuration), AggregationResponseOptionsTimersCallsDurationByResult callsDurationByResult = default(AggregationResponseOptionsTimersCallsDurationByResult), AggregationResponseOptionsTimersCallsDurationByCompanyHours callsDurationByCompanyHours = default(AggregationResponseOptionsTimersCallsDurationByCompanyHours), AggregationResponseOptionsTimersCallsDurationByQueueSla callsDurationByQueueSla = default(AggregationResponseOptionsTimersCallsDurationByQueueSla), AggregationResponseOptionsTimersCallsDurationByType callsDurationByType = default(AggregationResponseOptionsTimersCallsDurationByType))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AggregationResponseOptionsTimers {\n");
        ...
        {
            return this.Equals(input as AggregationResponseOptionsTimers);
        }

        /// <summary>
        /// Returns true if AggregationResponseOptionsTimers instances are equal
        /// </summary>
        /// <param name="input">Instance of AggregationResponseOptionsTimers to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AggregationResponseOptionsTimers input)
        {
            if (input == null)
                return false;
