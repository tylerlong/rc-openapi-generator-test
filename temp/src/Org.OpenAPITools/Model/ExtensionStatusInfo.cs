...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExtensionStatusInfo :  IEquatable<ExtensionStatusInfo>, IValidatableObject
    {
        /// <summary>
        /// Type of suspension
        /// </summary>
        ...
        {
            /// <summary>
            /// Enum Voluntarily for value: Voluntarily
            /// </summary>
            [EnumMember(Value = "Voluntarily")]
            Voluntarily = 1,

            /// <summary>
            /// Enum Involuntarily for value: Involuntarily
            /// </summary>
        ...
        public ExtensionStatusInfo(string comment = default(string), ReasonEnum? reason = default(ReasonEnum?))
        {
        ...
        {
            return this.Equals(input as ExtensionStatusInfo);
        }

        /// <summary>
        /// Returns true if ExtensionStatusInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of ExtensionStatusInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExtensionStatusInfo input)
        {
            if (input == null)
                return false;
