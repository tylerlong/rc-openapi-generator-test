...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MessageSenderInfo :  IEquatable<MessageSenderInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageSenderInfo" /> class.
        /// </summary>
        /// <param name="extensionNumber">extensionNumber.</param>
        /// <param name="extensionId">extensionId.</param>
        /// <param name="name">name.</param>
        public MessageSenderInfo(string extensionNumber = default(string), string extensionId = default(string), string name = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MessageSenderInfo {\n");
        ...
        {
            return this.Equals(input as MessageSenderInfo);
        }

        /// <summary>
        /// Returns true if MessageSenderInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of MessageSenderInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MessageSenderInfo input)
        {
            if (input == null)
                return false;
