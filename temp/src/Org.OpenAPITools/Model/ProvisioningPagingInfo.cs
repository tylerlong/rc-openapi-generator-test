...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProvisioningPagingInfo :  IEquatable<ProvisioningPagingInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProvisioningPagingInfo" /> class.
        /// </summary>
        ...
        public ProvisioningPagingInfo(int page = default(int), int perPage = default(int), int pageStart = default(int), int pageEnd = default(int), int totalPages = default(int), int totalElements = default(int))
        {
            this.Page = page;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProvisioningPagingInfo {\n");
        ...
        {
            return this.Equals(input as ProvisioningPagingInfo);
        }

        /// <summary>
        /// Returns true if ProvisioningPagingInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of ProvisioningPagingInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProvisioningPagingInfo input)
        {
            if (input == null)
                return false;
