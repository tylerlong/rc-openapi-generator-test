...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ServiceFeatureInfo :  IEquatable<ServiceFeatureInfo>, IValidatableObject
    {
        /// <summary>
        /// Feature name
        /// </summary>
        ...
        public ServiceFeatureInfo(FeatureNameEnum? featureName = default(FeatureNameEnum?), bool enabled = default(bool))
        {
        ...
        {
            return this.Equals(input as ServiceFeatureInfo);
        }

        /// <summary>
        /// Returns true if ServiceFeatureInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceFeatureInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceFeatureInfo input)
        {
            if (input == null)
                return false;
