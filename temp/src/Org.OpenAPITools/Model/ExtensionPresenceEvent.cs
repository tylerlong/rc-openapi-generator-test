...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExtensionPresenceEvent :  IEquatable<ExtensionPresenceEvent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExtensionPresenceEvent" /> class.
        /// </summary>
        ...
        public ExtensionPresenceEvent(string uuid = default(string), string _event = default(string), DateTime timestamp = default(DateTime), string subscriptionId = default(string), ExtensionPresenceEventBody body = default(ExtensionPresenceEventBody))
        {
            this.Uuid = uuid;
            this.Event = _event;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExtensionPresenceEvent {\n");
        ...
        {
            return this.Equals(input as ExtensionPresenceEvent);
        }

        /// <summary>
        /// Returns true if ExtensionPresenceEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of ExtensionPresenceEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExtensionPresenceEvent input)
        {
            if (input == null)
                return false;
