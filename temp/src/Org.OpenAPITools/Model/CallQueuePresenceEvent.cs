...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CallQueuePresenceEvent :  IEquatable<CallQueuePresenceEvent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CallQueuePresenceEvent" /> class.
        /// </summary>
        ...
        public CallQueuePresenceEvent(string uuid = default(string), string _event = default(string), DateTime timestamp = default(DateTime), string subscriptionId = default(string), CallQueuePresenceEventBody body = default(CallQueuePresenceEventBody))
        {
            this.Uuid = uuid;
            this.Event = _event;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CallQueuePresenceEvent {\n");
        ...
        {
            return this.Equals(input as CallQueuePresenceEvent);
        }

        /// <summary>
        /// Returns true if CallQueuePresenceEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of CallQueuePresenceEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallQueuePresenceEvent input)
        {
            if (input == null)
                return false;
