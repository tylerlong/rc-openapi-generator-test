...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CompanyAnsweringRuleRequest :  IEquatable<CompanyAnsweringRuleRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CompanyAnsweringRuleRequest" /> class.
        /// </summary>
        ...
        /// <param name="extension">Extension to which the call is forwarded in &#39;Bypass&#39; mode.</param>
        ...
        public CompanyAnsweringRuleRequest(string name = default(string), bool enabled = true, TypeEnum? type = default(TypeEnum?), List<CompanyAnsweringRuleCallersInfoRequest> callers = default(List<CompanyAnsweringRuleCallersInfoRequest>), List<CompanyAnsweringRuleCalledNumberInfo> calledNumbers = default(List<CompanyAnsweringRuleCalledNumberInfo>), CompanyAnsweringRuleScheduleInfoRequest schedule = default(CompanyAnsweringRuleScheduleInfoRequest), CallHandlingActionEnum? callHandlingAction = default(CallHandlingActionEnum?), string extension = default(string), List<GreetingInfo> greetings = default(List<GreetingInfo>))
        {
            this.Name = name;
        ...
        /// </summary>
        /// <value>Extension to which the call is forwarded in &#39;Bypass&#39; mode</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CompanyAnsweringRuleRequest {\n");
        ...
        {
            return this.Equals(input as CompanyAnsweringRuleRequest);
        }

        /// <summary>
        /// Returns true if CompanyAnsweringRuleRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyAnsweringRuleRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyAnsweringRuleRequest input)
        {
            if (input == null)
                return false;
