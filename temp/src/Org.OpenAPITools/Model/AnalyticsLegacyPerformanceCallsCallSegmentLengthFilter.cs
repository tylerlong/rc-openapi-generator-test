...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AnalyticsLegacyPerformanceCallsCallSegmentLengthFilter :  IEquatable<AnalyticsLegacyPerformanceCallsCallSegmentLengthFilter>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AnalyticsLegacyPerformanceCallsCallSegmentLengthFilter" /> class.
        /// </summary>
        /// <param name="minValueSeconds">minValueSeconds.</param>
        /// <param name="maxValueSeconds">maxValueSeconds.</param>
        public AnalyticsLegacyPerformanceCallsCallSegmentLengthFilter(long minValueSeconds = default(long), long maxValueSeconds = default(long))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AnalyticsLegacyPerformanceCallsCallSegmentLengthFilter {\n");
        ...
        {
            return this.Equals(input as AnalyticsLegacyPerformanceCallsCallSegmentLengthFilter);
        }

        /// <summary>
        /// Returns true if AnalyticsLegacyPerformanceCallsCallSegmentLengthFilter instances are equal
        /// </summary>
        /// <param name="input">Instance of AnalyticsLegacyPerformanceCallsCallSegmentLengthFilter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AnalyticsLegacyPerformanceCallsCallSegmentLengthFilter input)
        {
            if (input == null)
                return false;
