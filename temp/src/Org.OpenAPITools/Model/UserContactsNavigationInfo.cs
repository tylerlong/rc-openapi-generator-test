...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserContactsNavigationInfo :  IEquatable<UserContactsNavigationInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserContactsNavigationInfo" /> class.
        /// </summary>
        /// <param name="firstPage">firstPage.</param>
        /// <param name="nextPage">nextPage.</param>
        /// <param name="previousPage">previousPage.</param>
        /// <param name="lastPage">lastPage.</param>
        public UserContactsNavigationInfo(UserContactsNavigationInfoUri firstPage = default(UserContactsNavigationInfoUri), UserContactsNavigationInfoUri nextPage = default(UserContactsNavigationInfoUri), UserContactsNavigationInfoUri previousPage = default(UserContactsNavigationInfoUri), UserContactsNavigationInfoUri lastPage = default(UserContactsNavigationInfoUri))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserContactsNavigationInfo {\n");
        ...
        {
            return this.Equals(input as UserContactsNavigationInfo);
        }

        /// <summary>
        /// Returns true if UserContactsNavigationInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of UserContactsNavigationInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserContactsNavigationInfo input)
        {
            if (input == null)
                return false;
