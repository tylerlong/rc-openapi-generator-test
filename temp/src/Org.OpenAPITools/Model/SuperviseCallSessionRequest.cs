...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SuperviseCallSessionRequest :  IEquatable<SuperviseCallSessionRequest>, IValidatableObject
    {
        /// <summary>
        /// Supervising mode
        /// </summary>
        ...
        /// </summary>
        /// <value>Specifies session description protocol setting</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SuperviseCallSessionRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SuperviseCallSessionRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SuperviseCallSessionRequest" /> class.
        /// </summary>
        /// <param name="mode">Supervising mode (required).</param>
        /// <param name="supervisorDeviceId">Internal identifier of a supervisor&#39;s device which will be used for call session monitoring (required).</param>
        /// <param name="agentExtensionId">Extension identifier of the user that will be monitored.</param>
        ...
        /// <param name="mediaSDP">Specifies session description protocol setting.</param>
        public SuperviseCallSessionRequest(ModeEnum mode = default(ModeEnum), string supervisorDeviceId = default(string), string agentExtensionId = default(string), bool autoAnswer = true, MediaSDPEnum? mediaSDP = default(MediaSDPEnum?))
        {
            // to ensure "mode" is required (not null)
            if (mode == null)
            {
                throw new InvalidDataException("mode is a required property for SuperviseCallSessionRequest and cannot be null");
            }
            else
            {
                this.Mode = mode;
            ...
            {
                throw new InvalidDataException("supervisorDeviceId is a required property for SuperviseCallSessionRequest and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Internal identifier of a supervisor&#39;s device which will be used for call session monitoring</value>
        ...
        /// </summary>
        /// <value>Extension identifier of the user that will be monitored</value>
        [DataMember(Name="agentExtensionId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SuperviseCallSessionRequest {\n");
        ...
        {
            return this.Equals(input as SuperviseCallSessionRequest);
        }

        /// <summary>
        /// Returns true if SuperviseCallSessionRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SuperviseCallSessionRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SuperviseCallSessionRequest input)
        {
            if (input == null)
                return false;
