...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetPresenceExtensionInfo :  IEquatable<GetPresenceExtensionInfo>, IValidatableObject
    {
        /// <summary>
        ...
        public GetPresenceExtensionInfo(long id = default(long), string uri = default(string), string extensionNumber = default(string))
        {
            this.Id = id;
            this.Uri = uri;
        ...
        {
            return this.Equals(input as GetPresenceExtensionInfo);
        }

        /// <summary>
        /// Returns true if GetPresenceExtensionInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of GetPresenceExtensionInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetPresenceExtensionInfo input)
        {
            if (input == null)
                return false;
