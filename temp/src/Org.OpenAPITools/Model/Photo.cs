...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Photo :  IEquatable<Photo>, IValidatableObject
    {
        ...
        public Photo(TypeEnum type = default(TypeEnum), string value = default(string))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for Photo and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (value == null)
            {
                throw new InvalidDataException("value is a required property for Photo and cannot be null");
            }
            else
            {
                this.Value = value;
