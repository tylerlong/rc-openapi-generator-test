...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CallsByTypeBreakdown :  IEquatable<CallsByTypeBreakdown>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CallsByTypeBreakdown" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CallsByTypeBreakdown() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CallsByTypeBreakdown" /> class.
        /// </summary>
        /// <param name="direct">Value for Direct type (required).</param>
        /// <param name="fromQueue">Value for FromQueue type (required).</param>
        /// <param name="parkRetrieval">Value for ParkRetrieval type (required).</param>
        /// <param name="transferred">Value for Transferred type (required).</param>
        /// <param name="outbound">Value for Outbound type (required).</param>
        public CallsByTypeBreakdown(double direct = default(double), double fromQueue = default(double), double parkRetrieval = default(double), double transferred = default(double), double outbound = default(double))
        {
            // to ensure "direct" is required (not null)
            if (direct == null)
            {
                throw new InvalidDataException("direct is a required property for CallsByTypeBreakdown and cannot be null");
            }
            else
            {
                this.Direct = direct;
            ...
            if (fromQueue == null)
            {
                throw new InvalidDataException("fromQueue is a required property for CallsByTypeBreakdown and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("parkRetrieval is a required property for CallsByTypeBreakdown and cannot be null");
            }
            else
            {
            ...
            if (transferred == null)
            {
                throw new InvalidDataException("transferred is a required property for CallsByTypeBreakdown and cannot be null");
            }
            else
            {
            ...
            if (outbound == null)
            {
                throw new InvalidDataException("outbound is a required property for CallsByTypeBreakdown and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Value for Direct type</value>
        ...
        /// </summary>
        /// <value>Value for FromQueue type</value>
        ...
        /// </summary>
        /// <value>Value for ParkRetrieval type</value>
        ...
        /// </summary>
        /// <value>Value for Transferred type</value>
        ...
        /// </summary>
        /// <value>Value for Outbound type</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CallsByTypeBreakdown {\n");
        ...
        {
            return this.Equals(input as CallsByTypeBreakdown);
        }

        /// <summary>
        /// Returns true if CallsByTypeBreakdown instances are equal
        /// </summary>
        /// <param name="input">Instance of CallsByTypeBreakdown to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallsByTypeBreakdown input)
        {
            if (input == null)
                return false;
