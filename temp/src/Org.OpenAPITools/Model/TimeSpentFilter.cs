...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TimeSpentFilter :  IEquatable<TimeSpentFilter>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TimeSpentFilter" /> class.
        /// </summary>
        /// <param name="minSeconds">Minimum duration in seconds.</param>
        /// <param name="maxSeconds">Maximum duration in seconds.</param>
        public TimeSpentFilter(long minSeconds = default(long), long maxSeconds = default(long))
        {
        ...
        /// </summary>
        /// <value>Minimum duration in seconds</value>
        ...
        /// </summary>
        /// <value>Maximum duration in seconds</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TimeSpentFilter {\n");
        ...
        {
            return this.Equals(input as TimeSpentFilter);
        }

        /// <summary>
        /// Returns true if TimeSpentFilter instances are equal
        /// </summary>
        /// <param name="input">Instance of TimeSpentFilter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TimeSpentFilter input)
        {
            if (input == null)
                return false;
