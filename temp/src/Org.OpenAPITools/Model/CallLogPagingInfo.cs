...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CallLogPagingInfo :  IEquatable<CallLogPagingInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CallLogPagingInfo" /> class.
        /// </summary>
        ...
        /// <param name="perPage">Current page size, describes how many items are in each page. Maximum value is 1000. If perPage value in the request is greater than 1000, the maximum value (1000) is applied.</param>
        ...
        public CallLogPagingInfo(int page = default(int), int perPage = default(int), int pageStart = default(int), int pageEnd = default(int), int totalPages = default(int), int totalElements = default(int))
        {
            this.Page = page;
        ...
        /// </summary>
        /// <value>Current page size, describes how many items are in each page. Maximum value is 1000. If perPage value in the request is greater than 1000, the maximum value (1000) is applied</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CallLogPagingInfo {\n");
        ...
        {
            return this.Equals(input as CallLogPagingInfo);
        }

        /// <summary>
        /// Returns true if CallLogPagingInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of CallLogPagingInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallLogPagingInfo input)
        {
            if (input == null)
                return false;
