...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CompanyAnsweringRuleInfo :  IEquatable<CompanyAnsweringRuleInfo>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CompanyAnsweringRuleInfo" /> class.
        /// </summary>
        /// <param name="id">Internal identifier of an answering rule.</param>
        /// <param name="uri">Canonical URI of an answering rule.</param>
        /// <param name="enabled">Specifies if the rule is active or inactive (default to true).</param>
        ...
        public CompanyAnsweringRuleInfo(string id = default(string), string uri = default(string), bool enabled = true, TypeEnum? type = TypeEnum.Custom, string name = default(string), List<CompanyAnsweringRuleCallersInfoRequest> callers = default(List<CompanyAnsweringRuleCallersInfoRequest>), List<CompanyAnsweringRuleCalledNumberInfoRequest> calledNumbers = default(List<CompanyAnsweringRuleCalledNumberInfoRequest>), CompanyAnsweringRuleScheduleInfo schedule = default(CompanyAnsweringRuleScheduleInfo), CallHandlingActionEnum? callHandlingAction = default(CallHandlingActionEnum?), CompanyAnsweringRuleExtensionInfoRequest extension = default(CompanyAnsweringRuleExtensionInfoRequest), List<GreetingInfo> greetings = default(List<GreetingInfo>))
        {
            this.Id = id;
            this.Uri = uri;
        ...
        /// </summary>
        /// <value>Specifies if the rule is active or inactive</value>
        ...
        public List<CompanyAnsweringRuleCalledNumberInfoRequest> CalledNumbers { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CompanyAnsweringRuleInfo {\n");
        ...
        {
            return this.Equals(input as CompanyAnsweringRuleInfo);
        }

        /// <summary>
        /// Returns true if CompanyAnsweringRuleInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyAnsweringRuleInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyAnsweringRuleInfo input)
        {
            if (input == null)
                return false;
