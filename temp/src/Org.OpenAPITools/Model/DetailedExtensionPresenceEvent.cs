...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DetailedExtensionPresenceEvent :  IEquatable<DetailedExtensionPresenceEvent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DetailedExtensionPresenceEvent" /> class.
        /// </summary>
        ...
        public DetailedExtensionPresenceEvent(string uuid = default(string), string _event = default(string), DateTime timestamp = default(DateTime), string subscriptionId = default(string), DetailedExtensionPresenceEventBody body = default(DetailedExtensionPresenceEventBody))
        {
            this.Uuid = uuid;
            this.Event = _event;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DetailedExtensionPresenceEvent {\n");
        ...
        {
            return this.Equals(input as DetailedExtensionPresenceEvent);
        }

        /// <summary>
        /// Returns true if DetailedExtensionPresenceEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of DetailedExtensionPresenceEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DetailedExtensionPresenceEvent input)
        {
            if (input == null)
                return false;
