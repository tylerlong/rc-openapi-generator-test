...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CallHandlingPagingInfo :  IEquatable<CallHandlingPagingInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CallHandlingPagingInfo" /> class.
        /// </summary>
        ...
        public CallHandlingPagingInfo(int page = default(int), int perPage = default(int), int pageStart = default(int), int pageEnd = default(int), int totalPages = default(int), int totalElements = default(int))
        {
            this.Page = page;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CallHandlingPagingInfo {\n");
        ...
        {
            return this.Equals(input as CallHandlingPagingInfo);
        }

        /// <summary>
        /// Returns true if CallHandlingPagingInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of CallHandlingPagingInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallHandlingPagingInfo input)
        {
            if (input == null)
                return false;
