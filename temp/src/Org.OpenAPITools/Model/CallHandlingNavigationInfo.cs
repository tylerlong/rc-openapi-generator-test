...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CallHandlingNavigationInfo :  IEquatable<CallHandlingNavigationInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CallHandlingNavigationInfo" /> class.
        /// </summary>
        /// <param name="firstPage">firstPage.</param>
        /// <param name="nextPage">nextPage.</param>
        /// <param name="previousPage">previousPage.</param>
        /// <param name="lastPage">lastPage.</param>
        public CallHandlingNavigationInfo(CallHandlingNavigationInfoUri firstPage = default(CallHandlingNavigationInfoUri), CallHandlingNavigationInfoUri nextPage = default(CallHandlingNavigationInfoUri), CallHandlingNavigationInfoUri previousPage = default(CallHandlingNavigationInfoUri), CallHandlingNavigationInfoUri lastPage = default(CallHandlingNavigationInfoUri))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CallHandlingNavigationInfo {\n");
        ...
        {
            return this.Equals(input as CallHandlingNavigationInfo);
        }

        /// <summary>
        /// Returns true if CallHandlingNavigationInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of CallHandlingNavigationInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallHandlingNavigationInfo input)
        {
            if (input == null)
                return false;
