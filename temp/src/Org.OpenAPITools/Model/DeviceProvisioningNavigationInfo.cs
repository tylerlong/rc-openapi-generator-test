...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DeviceProvisioningNavigationInfo :  IEquatable<DeviceProvisioningNavigationInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceProvisioningNavigationInfo" /> class.
        /// </summary>
        /// <param name="firstPage">firstPage.</param>
        /// <param name="nextPage">nextPage.</param>
        /// <param name="previousPage">previousPage.</param>
        /// <param name="lastPage">lastPage.</param>
        public DeviceProvisioningNavigationInfo(DeviceProvisioningNavigationInfoUri firstPage = default(DeviceProvisioningNavigationInfoUri), DeviceProvisioningNavigationInfoUri nextPage = default(DeviceProvisioningNavigationInfoUri), DeviceProvisioningNavigationInfoUri previousPage = default(DeviceProvisioningNavigationInfoUri), DeviceProvisioningNavigationInfoUri lastPage = default(DeviceProvisioningNavigationInfoUri))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceProvisioningNavigationInfo {\n");
        ...
        {
            return this.Equals(input as DeviceProvisioningNavigationInfo);
        }

        /// <summary>
        /// Returns true if DeviceProvisioningNavigationInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceProvisioningNavigationInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceProvisioningNavigationInfo input)
        {
            if (input == null)
                return false;
