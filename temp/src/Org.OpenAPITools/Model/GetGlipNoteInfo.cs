...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetGlipNoteInfo :  IEquatable<GetGlipNoteInfo>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetGlipNoteInfo" /> class.
        /// </summary>
        ...
        /// <param name="body">Text of a note.</param>
        ...
        public GetGlipNoteInfo(string id = default(string), string title = default(string), List<string> chatIds = default(List<string>), string preview = default(string), string body = default(string), GlipCreatorInfo creator = default(GlipCreatorInfo), LastModifiedByInfo lastModifiedBy = default(LastModifiedByInfo), LockedByInfo lockedBy = default(LockedByInfo), StatusEnum? status = default(StatusEnum?), string creationTime = default(string), string lastModifiedTime = default(string), TypeEnum? type = default(TypeEnum?))
        {
            this.Id = id;
            this.Title = title;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetGlipNoteInfo {\n");
        ...
        {
            return this.Equals(input as GetGlipNoteInfo);
        }

        /// <summary>
        /// Returns true if GetGlipNoteInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of GetGlipNoteInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetGlipNoteInfo input)
        {
            if (input == null)
                return false;
