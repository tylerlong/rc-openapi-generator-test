...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MessageStoreCallerInfoResponseFrom :  IEquatable<MessageStoreCallerInfoResponseFrom>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageStoreCallerInfoResponseFrom" /> class.
        /// </summary>
        ...
        public MessageStoreCallerInfoResponseFrom(string extensionNumber = default(string), string extensionId = default(string), string location = default(string), string name = default(string), string phoneNumber = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MessageStoreCallerInfoResponseFrom {\n");
        ...
        {
            return this.Equals(input as MessageStoreCallerInfoResponseFrom);
        }

        /// <summary>
        /// Returns true if MessageStoreCallerInfoResponseFrom instances are equal
        /// </summary>
        /// <param name="input">Instance of MessageStoreCallerInfoResponseFrom to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MessageStoreCallerInfoResponseFrom input)
        {
            if (input == null)
                return false;
