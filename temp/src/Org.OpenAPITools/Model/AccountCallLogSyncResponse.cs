...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AccountCallLogSyncResponse :  IEquatable<AccountCallLogSyncResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountCallLogSyncResponse" /> class.
        /// </summary>
        /// <param name="uri">Link to account call log sync resource.</param>
        ...
        public AccountCallLogSyncResponse(string uri = default(string), List<CompanyCallLogRecord> records = default(List<CompanyCallLogRecord>), CompanyCallLogSyncInfo syncInfo = default(CompanyCallLogSyncInfo))
        {
            this.Uri = uri;
        ...
        /// </summary>
        /// <value>Link to account call log sync resource</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountCallLogSyncResponse {\n");
        ...
        {
            return this.Equals(input as AccountCallLogSyncResponse);
        }

        /// <summary>
        /// Returns true if AccountCallLogSyncResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountCallLogSyncResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountCallLogSyncResponse input)
        {
            if (input == null)
                return false;
