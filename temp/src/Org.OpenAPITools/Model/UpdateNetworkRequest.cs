...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateNetworkRequest :  IEquatable<UpdateNetworkRequest>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as UpdateNetworkRequest);
        }

        /// <summary>
        /// Returns true if UpdateNetworkRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateNetworkRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateNetworkRequest input)
        {
            if (input == null)
                return false;
