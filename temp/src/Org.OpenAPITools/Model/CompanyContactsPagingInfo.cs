...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CompanyContactsPagingInfo :  IEquatable<CompanyContactsPagingInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CompanyContactsPagingInfo" /> class.
        /// </summary>
        ...
        public CompanyContactsPagingInfo(int page = default(int), int totalPages = default(int), int perPage = default(int), int totalElements = default(int), int pageStart = default(int), int pageEnd = default(int))
        {
            this.Page = page;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CompanyContactsPagingInfo {\n");
        ...
        {
            return this.Equals(input as CompanyContactsPagingInfo);
        }

        /// <summary>
        /// Returns true if CompanyContactsPagingInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyContactsPagingInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyContactsPagingInfo input)
        {
            if (input == null)
                return false;
